 ...
 <?php
    ...
    <div class="bread-crumb">
    	<div class="auto-container">
        	Pagina  &ensp;<span class="fa fa-angle-right"></span>&ensp; <a href="#" class="ative">Portfolio</a>
        </div>
    </div>
    ...
    <section id="project-version-one" class="project-v3">
        <div class="container">
            ...
            <div class="row normal-gallery two-col-gallery" id="image-gallery-mix">
				...
				<a href="cms/images/<?php echo utf8_encode($rs2['Screen_sitio_sistema_portfolio_570_x_295_px']);?>" class="fancybox" ><div class="col-lg-6 col-sm-6 col-xs-12 tank smiling single-project-item hvr-float-shadow mix">
                    <div class="img-wrap">
                        <div class="overlay"><img src="cms/images/<?php echo utf8_encode($rs2['Screen_sitio_sistema_portfolio_570_x_295_px']);?>" alt=""></div>
                    </div>
                    <div class="content hvr-bounce-to-bottom">
                        <h4><?php echo utf8_encode($rs2['empresa']);?> </h4>
                        <span><?php echo utf8_encode($rs2['subtitulo']);?></span>
                    </div>
                </div></a><?php } ?> 
