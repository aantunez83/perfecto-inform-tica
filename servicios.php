 ...
 <?php
    ...
    <div class="bread-crumb">
    	<div class="auto-container">
        	Pagina  &ensp;<span class="fa fa-angle-right"></span>&ensp; <a href="#" class="ative">Servicios</a>
        </div>
    </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 buttons-side">
                        ...
                        <ul class="tab-buttons
						  ...
						  <?php
							...
							$query2="select * from servicios where idservicio = 1 order by idservicio";
...
<?php } ?>            </BR>                <?php
							...
							$query2="select * from servicios where idservicio = 2 order by idservicio";
					  ...
					  { ?>
                       ...
                       <?php } ?>                            <?php
							...
							$query2="select * from servicios where idservicio = 3 order by idservicio";
...
<?php } ?>                            <?php
							...
							$query2="select * from servicios where idservicio = 4 order by idservicio";
