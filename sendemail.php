                ...
                <div class="col-md-9 col-sm-6 col-xs-12">
                    <section class="contact-section">
						...
						<div class="form">
                            ...
                            <img src="images/estado-de-mensaje.png" alt="Mensaje Enviado Satisfactoriamente">
						...
						$sAsunto = "Formulario de Contacto"."-".$_GET['username'];
$sPara   = $_GET['para'];
//$sPara   = 'dnl_gnzlz@hotmail.com';
$Asunto = $_GET['subject'];
$mensaje = $_GET['mensaje'];
$sDe     = "matka@matka.com.py";
$email=$_GET['email'];
...
//$destinatario = 'dsantacruz360@gmail.com';
//$destinatario = "rrhh@aj.com.py"; 
...
'; 
						...
						mail($destinatario,"Formulario de Contacto",$cuerpo) ?>
